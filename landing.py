...
""", unsafe_allow_html=True)
            ...
            # --- Стилизация слова Google ---
            def get_colored_google(text):
                google_html = (
                ...
                return text.replace("Google", google_html)
            ...
            with tab1:
                ...
                google_text_login = get_colored_google(t("auth_google_login"))
                st.html(f'''
                    <div style="margin-bottom: 0.5rem;">
                        <a href="{google_url}" 
                           ...
                           class="oauth-btn" 
                           id="{btn_id}"
                           style="text-decoration: none; display: flex !important; align-items: center !important; justify-content: center !important; gap: 12px !important; width: 100% !important; background: #ffffff !important; color: #3c4043 !important; border: 1px solid #dadce0 !important; border-radius: 12px !important; padding: 12px !important; font-family: 'Google Sans', 'Roboto', sans-serif !important; font-weight: 500 !important; font-size: 0.95rem !important; cursor: pointer !important; transition: all 0.2s !important; position: relative !important; z-index: 99999 !important; box-shadow: 0 1px 2px rgba(0,0,0,0.05) !important;"
                           ...
                           onclick="window.top.location.href='{google_url}'; return false;">
            ...
            with tab2:
                ...
                google_text_signup = get_colored_google(t("auth_google_signup"))
                st.html(f'''
                    <div style="margin-bottom: 0.5rem;">
                        <a href="{google_url}" 
                           target="_top" 
