...
![Version](https://img.shields.io/badge/version-v3.6-blue) ![Status](https://img.shields.io/badge/status-Active%20Development-orange) ![Python](https://img.shields.io/badge/python-3.10+-yellow) ![Languages](https://img.shields.io/badge/languages-8-green)
...
| `profile_page.py` | Личный кабинет: профиль, данные, профили детей, удаление аккаунта |
...
| `storage.py` | Хранилище (Supabase + Local JSON): сказки и профили детей |
...
> 
> **Важно**: Для корректной работы авторизации (OAuth) при локальной разработке, добавьте `http://localhost:8501` в список **Redirect URLs** в панели управления Supabase (Authentication -> URL Configuration).
...
- 👤 **Личный кабинет** — профиль, дата регистрации, план, профили детей, удаление аккаунта
- 🧒 **Профили детей** — сохранение имен, возраста и хобби для мгновенной персонализации
