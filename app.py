        ...
        with st.spinner('🪄 Сочиняем волшебную историю...'):
            ...
            for model_name in model_candidates:
                try:
                    ...
                    if age <= 4:
                        # Малыши (1-4 года)
                        role_instruction = "Ты — ласковая бабушка-сказочница."
                        style_instruction = """
                        Стиль: Очень простой, мягкий, успокаивающий. Используй короткие предложения.
                        Повторяй важные моменты (как в сказке 'Репка' или 'Колобок').
                        Фокус на знакомых, безопасных предметах (игрушки, животные, дом, семья).
                        Избегай пугающих элементов.
                        Лексика: Только простые слова, понятные малышу.
                        Длина: Около 150 слов.
                        """
                        structure_instruction = "Структура: Приветствие -> Маленькое понятное событие -> Радостный вывод."
                        ending_instruction = "В конце задай один очень простой вопрос ребенку (например: 'А у тебя есть такая игрушка?')."
                        
                    elif 5 <= age <= 8:
                        # Дошкольники (5-8 лет)
                        role_instruction = "Ты — веселый рассказчик, как в мультиках Disney или Pixar."
                        style_instruction = """
                        Стиль: Энергичный, яркий, с диалогами.
                        Герой должен столкнуться с небольшой проблемой и решить её или чему-то научиться.
                        Темы: Дружба, честность, школа/садик, помощь другим.
                        Длина: Около 250 слов.
                        """
                        structure_instruction = "Структура: Завязка -> Приключение/Проблема -> Решение -> Счастливый конец."
                        ending_instruction = "В конце спроси ребенка: 'А как бы ты поступил на месте героя?'."

                    else:
                        # Школьники (9-12+ лет)
                        role_instruction = "Ты — автор подростковых приключенческих книг (Young Adult)."
                        style_instruction = """
                        Стиль: Увлекательный, динамичный, можно добавить немного доброго юмора или легкой иронии.
                        Сюжет может быть сложнее: путешествия, магия, наука, личные достижения.
                        Герой должен проявить смекалку или смелость.
                        Длина: Около 350-400 слов.
                        """
                        structure_instruction = "Структура: Интригующая завязка -> Развитие сюжета -> Кульминация (испытание) -> Развязка."
                        ending_instruction = "В конце задай вопрос на размышление, связывающий сказку с реальной жизнью."

                    prompt = f"""
                    {role_instruction}
                    Напиши сказку для ребенка {age} лет.
                    Главного героя зовут {name}.
                    Обязательно используй интересы: {hobbies}.
                    Язык: Русский.
                    ...
                    Важные требования:
                    1. Следи за правильным склонением имени ребенка по падежам.
                    2. Первой строкой напиши Название сказки.
                    3. Используй эмодзи в тексте.
                    4. Не используй Markdown-заголовки (###), просто текст с абзацами.
                    5. Обязательно выдели (но не занудно) мораль истории.
                    6. {ending_instruction}
                    """
