            ...
            for model_name in model_candidates:
                try:
                    ...
                    if age <= 4:
                        ...
                        ending_instruction = "В конце задай малышу простой вовлекающий вопрос по сюжету."
                        ...
                        ending_instruction = "Закончи вопросом, который заставит ребенка задуматься о морали сказки."
                        ...
                        ending_instruction = "Сделай финал вдохновляющим к действию или изучению нового."
                    ...
                    4. **Финал**: История должна оставлять теплое чувство и желание перечитать.
